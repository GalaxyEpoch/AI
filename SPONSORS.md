...
GalaxyEpoch 是一个**永久开源免费**的大模型聚合客户端。如果你觉得它有用，欢迎赞助支持持续开发！
...
| 平台 | 链接 | 特点 |
|------|------|------|
| ❤️ **GitHub Sponsors** | [赞助](https://github.com/sponsors/GalaxyEpoch) | 0% 手续费，按月/一次性 |
...
| 🙏 **thanks.dev** | [支持](https://thanks.dev/u/gh/GalaxyEpoch) | 自动化开源贡献打赏 |
| 🏗️ **Open Collective** | [赞助](https://opencollective.com/galaxyepoch) | 透明财务，企业友好 |
...
| 层级 | 月费 | README Logo | 项目网站 Logo | 优先 Issue | 专属功能请求 | 私有频道 |
|------|------|-------------|---------------|-----------|-------------|---------|
| ☕ Coffee | $5 | ✅ 小 | - | - | - | - |
| 🥈 Silver | $25 | ✅ 中 | ✅ 小 | ✅ | - | - |
| 🥇 Gold | $50 | ✅ 大 | ✅ 中 | ✅ | ✅ | - |
...
> 💡 想成为赞助商？[点击这里 →](https://github.com/sponsors/GalaxyEpoch)

---

## 📊 资金透明度

所有赞助资金的使用情况将在 Open Collective 上公开透明展示。

---

*感谢每一位支持者！你们让 GalaxyEpoch 变得更好 🙏*
